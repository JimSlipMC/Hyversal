...
public class BroadcastRawCommand implements CommandExecutor {


	public BroadcastRawCommand(Unity unity) { }
	...
	public boolean onCommand(CommandSender s, Command cmd, String L, String[] args) {
		...
		if(args.length == 0) {
			s.sendMessage(ChatColor.RED + "Usage: /broadcastraw <Message>");
			return true;
		}
